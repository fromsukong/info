...
/**
 * fromsukong theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { fromsukongTheme } from './fromsukong';
 *   import './fromsukong.css';
 */
export const fromsukongTheme = {
  name: 'fromsukong',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#000000, #000000)",
    "--color-background-body": "light-dark(#000000, #000000)",
    ...
    "--color-text-primary": "light-dark(#f5f6f7, #f5f6f7)",
    "--color-text-secondary": "light-dark(rgba(245, 246, 247, 0.72), rgba(245, 246, 247, 0.72))",
    ...
    "--color-icon-primary": "light-dark(#f5f6f7, #f5f6f7)",
    "--color-icon-secondary": "light-dark(rgba(245, 246, 247, 0.72), rgba(245, 246, 247, 0.72))",
    "--color-icon-disabled": "#495056",
    "--color-background-card": "light-dark(#141414, #141414)",
    "--color-background-popover": "#24292D",
    "--color-background-inverted": "light-dark(#f5f6f7, #f5f6f7)",
    ...
    "--color-border": "light-dark(rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.15))",
    "--color-border-emphasized": "light-dark(rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0.3))",
