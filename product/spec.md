...
- **Products-dev**: registered as a sparse submodule at `products-dev/repos/info` (checks out `product/` only).
- **Hosting**: deployed on Cloudflare Pages under `info.fromsukong.com`.
